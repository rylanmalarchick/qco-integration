...
Table~\ref{tab:hw-results} reports, for each circuit, the measured hardware fidelity alongside the validated Lindblad model's prediction. Figure~\ref{fig:hw-gap} visualizes the comparison.
